...
set :application, 'NRUSpaceTeam'
set :repo_url, 'https://github.com/Dragoon013/spaceteam_assets_fixed.git' # Edit this to match your repository
set :branch, :master
set :deploy_to, '/home/deploy/nru-space-team'
set :pty, true
